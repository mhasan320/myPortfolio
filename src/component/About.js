...
export default function About() {
  return (
    <div className="bg-gray-50 dark:bg-gray-700 relative z-50">
      <div className="container px-5 mx-auto text-center md:text-left py-16 md:py-24">
        ...
        <div className="block lg:flex mt-20">
          <div className="lg:w-4/12 w-full m-auto">
            <img
              src={aboutImg}
              alt="about"
          ...
          <div className="lg:w-8/12 px-5 md:px-0 md:ml-7 mt-0 md:mt-12 ml-0">
            <div className="dark:text-white m-auto sm:ml-0 text-justify mt-3 text-md">
              <p>
            ...
            <hr className="mt-5 dark:border-gray-800" />
            <div className="text-center dark:text-white sm:text-left block md:flex justify-between mt-5 md:text-lg">
